...
<table>
	<tr><td>文章ID<td><input type="text" disabled value="${art.artid}">
	<tr><td>標題<td><input type="text" disabled value="${art.title}">
	<tr><td>文章內容<td><input type="text" disabled value="${art.maincontent}">
	<tr><td>發文者帳號<td><input type="text" disabled value="${art.authorid}">
	<tr><td>類別<td><input type="text" disabled value="${art.categoryid}">
	<tr><td>發文日期<td><input type="text" disabled value="${art.createtime}">
	<tr><td>修改日期<td><input type="text" disabled value="${art.updatetime}">
	<tr><td>狀態<td><input type="text" disabled value="${art.state}">
	<tr><td>縮圖<td><img  src="data:image/png;base64,${art.img}">
</table>
